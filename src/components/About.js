...
export default function About() {
    return (
        <section id="about">
            ...
            labo        rum quasi, incidunt dolore iste nostrum cupiditate voluptas?
            Labo        rum, voluptas natus?
                    </p>
                ...
                <div className="lg:max-w-lg lg:w-full">
                    <img className="object-cover object-center mx-auto sm:w-70 sm:h-70 md:w-70 md:h-70 lg:w-96 lg:h-96" alt="hero" src="./profile.png" />
                </div>
            </div>
        </section>
    )
